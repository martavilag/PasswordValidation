...
2. The password must contain at least 2 numbers. If it is not met, then the following error message should be returned: “Password must contain at least 2 numbers”
